...
interface IProcessZone {
  setOpen: React.Dispatch<React.SetStateAction<boolean>>;
}
const ProcessZone: FC<IProcessZone> = ({ setOpen }: IProcessZone) => {
  return (
  ...
  return (
    <div>
      ...
      <div className="description-loadmap">
        <div>
          로드맵 템플릿을 사용하면 모든 프로젝트의 작업을 기록할 수 있습니다.
        </div>
        ...
        <div className="description-margin ">
          ↓ 에픽, 스프린트, 작업, 버그로 작업을 구분하려면 상태별을 클릭하세요.
          상태, 엔지니어, 제품 관리자별로 작업을 정렬할 수도 있습니다. 작업의
          완료 예정일을 보려면 캘린더 보기로 전환하세요.
        </div>
      </div>
    </div>
  );
